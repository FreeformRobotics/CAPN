...
nohup python -m torch.distributed.launch --master_port 33375 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       > logs/training_transformer-sgdet-CROSS_ENTROPY_LOSS.txt 2>&1 &
