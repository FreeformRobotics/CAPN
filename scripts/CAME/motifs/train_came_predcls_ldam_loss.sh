...
nohup python -m torch.distributed.launch --master_port 41101 --nproc_per_node=2 tools/relation_train_net.py \
       --config-file "configs/e2e_relation_X_101_32_8_FPN_1x.yaml" \
       --loss_option LDAM_LOSS_PN \
       --num_experts 3 \
       ...
       OUTPUT_DIR ./checkpoints/motif-predcls-LDAM_LOSS_PN > logs/CAPN/motif-predcls-LDAM_LOSS_PN.log 2>&1 &
