...
nohup  python -m torch.distributed.launch --master_port 31175 --nproc_per_node=2 tools/relation_test_net.py \
       ...
       OUTPUT_DIR ./checkpoints/motif-predcls-CAME3_0.25/ \
       > logs/CAME/output_0.txt 2>&1 &
