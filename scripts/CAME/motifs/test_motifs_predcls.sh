...
nohup python -m torch.distributed.launch --master_port 41175 --nproc_per_node=2 tools/relation_test_net.py \
       ...
       > logs/test_motif-predcls-CROSS_ENTROPY_LOSS.txt 2>&1 &
