...
nohup python -m torch.distributed.launch --master_port 41175 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/motif-predcls-CROSS_ENTROPY_LOSS \
       > logs/training_motif-predcls-CROSS_ENTROPY_LOSS.txt 2>&1 &
