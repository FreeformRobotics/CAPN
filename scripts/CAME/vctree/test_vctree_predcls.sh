...
nohup python -m torch.distributed.launch --master_port 98375 --nproc_per_node=2 tools/relation_test_net.py \
       ...
       > logs/test_vctree-precls-CROSS_ENTROPY_LOSS.txt 2>&1 &
