...
nohup python -m torch.distributed.launch --master_port 32185 --nproc_per_node=2 tools/relation_test_net.py \
      ...
      OUTPUT_DIR ./checkpoints/vctree-PL-sgdet-hbt_b_t > logs/vctree-PL-sgdet-hbt_b_t_predicate_labels_predicate_scores.txt 2>&1 &
