...
LOG_FILE_1="logs/trans-PL-sgcls-hbt_b_t_predicate_label_lst_predicate_scores_matrix.txt"
LOG_FILE_2="logs/vctree-PL-sgcls-hbt_b_t_predicate_label_lst_predicate_scores_matrix.txt"
LOG_FILE_3="logs/motifs-PL-sgcls-hbt_b_t_predicate_label_lst_predicate_scores_matrix.txt"
...
execute_and_log "scripts/PLME/transformer/test_sgcls.sh" "$LOG_FILE_1"
execute_and_log "scripts/PLME/vctree/test_sgcls.sh" "$LOG_FILE_2"
execute_and_log "scripts/PLME/motifs/test_sgcls.sh" "$LOG_FILE_3"
