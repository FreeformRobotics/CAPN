...
python -m torch.distributed.launch --master_port 38085 --nproc_per_node=2 \
      ...
      MODEL.ROI_RELATION_HEAD.EXPERT_MODE 'h_m_t' \
      ...
      OUTPUT_DIR ./checkpoints/trans-PL-precls-h_m_t
