...
nohup python -m torch.distributed.launch --master_port 32112 --nproc_per_node=2 \
      ...
      OUTPUT_DIR ./checkpoints/trans-PL-sgdet-hbt_b_t > logs/trans-PL-sgdet-hbt_b_t_predicate_labels_predicate_scores.txt 2>&1 &
