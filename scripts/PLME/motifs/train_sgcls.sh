...
nohup python -m torch.distributed.launch --master_port 67085 --nproc_per_node=2 \
      ...
      MODEL.ROI_RELATION_HEAD.EXPERT_MODE 'hbt_hb_ht_bt' \
      ...
      OUTPUT_DIR ./checkpoints/motif-PL-sgcls-hbt_hb_ht_bt_new > logs/motif-PL-sgcls-hbt_hb_ht_bt_new.txt 2>&1 &
