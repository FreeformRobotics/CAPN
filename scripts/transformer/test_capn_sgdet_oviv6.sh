...
python -m torch.distributed.launch --master_port 11275 --nproc_per_node=2 tools/relation_test_net.py \
       ...
       OUTPUT_DIR ./checkpoints/transformer-sgdet-CAME_LOSS-oviv6_1.0
