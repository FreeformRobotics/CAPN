...
python -m torch.distributed.launch --master_port 98375 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/vctree-precls-CAME_LOSS_WO_RW_1.0
