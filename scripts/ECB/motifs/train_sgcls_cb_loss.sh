...
nohup python -m torch.distributed.launch --master_port 20275 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/motif-sgcls-CB_LOSS_33864 > logs/motif-PL-sgcls-CB_LOSS_33864.log 2>&1 &
