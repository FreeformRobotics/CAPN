...
python -m torch.distributed.launch --master_port 23321 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/motif-sgdet-CB_LOSS_33864 > logs/motif-PL-sgdet-CB_LOSS_33864.log 2>&1 &
