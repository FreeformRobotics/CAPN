...
nohup python -m torch.distributed.launch --master_port 23123 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/transformer-sgcls-CB_LOSS_33864 > logs/transformer-sgcls-CB_LOSS_33864.log 2>&1 & 
