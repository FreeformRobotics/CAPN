...
nohup python -m torch.distributed.launch --master_port 45541 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/transformer-sgdet-CB_LOSS_33864 > logs/transformer-sgdet-CB_LOSS_33864.log 2>&1 & 
