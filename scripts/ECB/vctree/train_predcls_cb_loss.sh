...
nohup python -m torch.distributed.launch --master_port 67375 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/vctree-precls-CB_LOSS_0 > logs/ECB/vctree/precls-CB_LOSS_0.log 2>&1 &
