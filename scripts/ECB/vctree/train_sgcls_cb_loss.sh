...
nohup python -m torch.distributed.launch --master_port 45345 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/vctree-sgcls-CB_LOSS_33864 > logs/vctree-sgcls-CB_LOSS_33864.log 2>&1 &
