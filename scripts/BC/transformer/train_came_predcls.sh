...
python -m torch.distributed.launch --master_port 43175 --nproc_per_node=2 tools/relation_train_net.py \
       ...
       OUTPUT_DIR ./checkpoints/transformer-predcls-CAME3_test_1.0    
