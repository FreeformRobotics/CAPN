...
def get_dataset_statistics(cfg):
    ...
    results = {
        ...
        'rel_class_num_lst': statistics[0]['rel_class_num_lst'],
        'obj_class_num_lst': statistics[0]['obj_class_num_lst'],
    ...
    # print('fg_matrix.shape:', results['fg_matrix'].shape)        # 151, 151, 51
    # print('pred_dist.shape:', results['pred_dist'].shape)        # 151, 151, 51
    # print('rel_class_num_lst:', results['rel_class_num_lst'])        # 151, 151, 51
    # print('obj_classes.shape:', len(results['obj_classes']))     # 151
    # print('rel_classes.shape:', len(results['rel_classes']))     # 51
    # print('att_classes.shape:', len(results['att_classes']))     # 201
...
def build_dataset(cfg, dataset_list, transforms, dataset_catalog, is_train=True):
    ...
    # print('len(dataset_list):', len(dataset_list), dataset_list)
...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0):
    ...
    # print('paths_catalog:', paths_catalog)
    DatasetCatalog = paths_catalog.DatasetCatalog
