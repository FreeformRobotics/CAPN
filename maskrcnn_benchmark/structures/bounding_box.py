...
class BoxList(object):
    ...
    def remove_field(self, field):
        if field in self.extra_fields:
            ...
            print(f"Field '{field}' not found in extra_fields")
    ...
    def copy_with_fields(self, fields, skip_missing=False):
        ...
        # bbox.extra_fields = {}  # we clear the fields and will add only the ones specified
...
if __name__ == "__main__":
    ...
    bbox1 = BoxList([[0, 0, 10, 10], [0, 0, 5, 5]], (10, 10))
    print('bbox:', bbox)
    print('bbox1:', bbox1)
