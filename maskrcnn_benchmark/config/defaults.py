...
# Value used for CAME Loss computation
_C.MODEL.REL_CLASS_NUM_LST = []
_C.MODEL.OBJ_CLASS_NUM_LST = []
...
#_C.MODEL.PRETRAINED_DETECTOR_CKPT = "datasets/vg/detector_model/pretrained_faster_rcnn/model_final.pth"
#_C.MODEL.PRETRAINED_DETECTOR_CKPT = "./checkpoints/pretrained_detector/oiv6_det.pth"
_C.MODEL.PRETRAINED_DETECTOR_CKPT = "./checkpoints/pretrained_detector/oiv6_det.pth"
...
## CAME, 2022
_C.MODEL.ROI_RELATION_HEAD.LOSS_OPTION = "CAME_LOSS"
_C.MODEL.ROI_RELATION_HEAD.NUM_EXPERTS = 2
_C.MODEL.ROI_RELATION_HEAD.EXPERT_MODE = 'hmt_ht_mt'
_C.MODEL.ROI_RELATION_HEAD.USE_RELATION_AWARE_GATING = False
_C.MODEL.ROI_RELATION_HEAD.USE_PER_CLASS_CONTEXT_AWARE = False
_C.MODEL.ROI_RELATION_HEAD.PER_CLASS_ALPHA = 1.0
_C.MODEL.ROI_RELATION_HEAD.NUM_CLASSES = 51
_C.MODEL.ROI_RELATION_HEAD.RELATION_SAMPLING = False
_C.MODEL.ROI_RELATION_HEAD.EXPERT_VOTING = False
...
_C.MODEL.ROI_RELATION_HEAD.LONGTAIL_PART_DICT = ['None', 'h', 't', 't', 'b', 'b', 'h', 'b', 'h', 'b', 'b', 'b', 't', 'b', 'b', 't', 'b', 't', 't', 'b', 'h', 'h', 'h', 'h', 'b', 'b', 't', 't', 't', 'h', 'h', 'h', 't', 'b', 't', 'b', 't', 't', 'h', 't', 'h', 'h', 't', 'h', 'b', 't', 'b', 'b', 'h', 'h', 'h']
...
_C.PATHS_DATA = os.path.join(os.path.dirname(__file__), "../usgg/CAME/datasets/vg/datasets")
