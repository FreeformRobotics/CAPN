...
# Value used for LDAM Loss computation
...
## CAME, 2022
_C.MODEL.ROI_RELATION_HEAD.LOSS_OPTION = "RIDE_LOSS"
...
_C.PATHS_CATALOG = os.path.join('maskrcnn_benchmark', 'config', "paths_catalog.py")
