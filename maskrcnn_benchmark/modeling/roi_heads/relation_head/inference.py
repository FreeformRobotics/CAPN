...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, rel_pair_idxs, boxes):
        ...
        for i, (rel_logit, obj_logit, rel_pair_idx, box) in enumerate(zip(
            ...
            # print('rel_class_prob:', rel_class_prob.shape, rel_class_prob)
            ...
            # boxlist.get_field('pred_labels')
            
            
            bbox_copy = boxlist.copy_with_fields(boxlist.fields())
            #copy_boxlist = boxlist.copy()
            #print('copy_boxlist:', copy_boxlist)
            
            results.append(bbox_copy)
